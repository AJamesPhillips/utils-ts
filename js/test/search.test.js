...
describe("binary_search_vlookup", function () {
    ...
    it("matching value", function () {
        ...
        expect(search_1.binary_search_vlookup([e("one", 1), e("two", 2)], 2)).toEqual({ index: 1, value: e("two", 2) });
        expect(search_1.binary_search_vlookup([e("one", 1), e("two", 2), e("three", 3)], 2)).toEqual({ index: 1, value: e("two", 2) });
        expect(search_1.binary_search_vlookup([e("one", 1), e("two", 2), e("three", 3)], 1)).toEqual({ index: 0, value: e("one", 1) });
    });
    it("sets min correctly", function () {
        expect(search_1.binary_search_vlookup([e("-two", -2)], -2)).toEqual({ index: 0, value: e("-two", -2) });
    });
